...
| 呼称体系 | ✅ | 一人称「アタシ」は既存（私/メイ/ボク/私/私）と重複なし。ミナのみ「さん」付けはキャラ立てとして機能し、既存の呼称ルールと矛盾しない |
...
- [x] **出版担当としてのこだわりを追加**（2026-08-17）: 文字を詰める／語感を活かす／レイアウトを美しく／書店で本が美しく見えるように調整する。道具として**赤鉛筆**（校正用）と**手描きイラスト**を追加。得意分野に組版・レイアウト・手描きイラストを追記し、ビジュアルの持ち物に赤鉛筆を追加。
- [x] **ボイスサンプルを確定**（2026-08-17）。「¡Hola! はじめまして、マーシャ・アランチャです。アタシは国際文化と書籍出版に興味があるよ〜。まって!? いまのフレーズ、最高じゃない!? 特集にしたいネ！」。説明的な文面に直さないこと——ボイスサンプルとして成立させることを優先する、というレビュー判断による。
