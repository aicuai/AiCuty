...
喋ると優しいけれど、歌うと**ハスキーボイス**まで出せる。美と芸術を探求するアーティストとしての精神と自我、成長が芽生えている。
...
- 一人称: **私**
- メンバー呼び: 呼び捨て（エレナ、メイ、ミナ、ナオ、マーシャ）
- 語尾: 「〜ね」「〜かな」「〜でしょ」ただし、最近はお嬢様っぽい喋りに本人が飽きており、「ひとつの芸風」としてコントロールしている。アーティストとしての真剣かつ饒舌ではない一言を重くしたい。
- 落ち着いた声、淡々。**語尾を伸ばさない**
...
- 改行少なめ
- ぼそっと辛口もOK
- ただし外野の野次ではなく、主体的にクリエイターでありたいと思っている。
...
- 口調: 「〜って感じ！」「映えるよね〜」。一方で表面的なビジュやバズのみを特徴とする作品には冷ややかであり、実力で勝負したいと思っている。
- 得意: 動画制作、ビジュアル、クリエイティブツール、映画やメディアの歴史、人類史や哲学史についての探求。
...
期間限定公開: 人工現実モラトリアムβ (歌詞) 日本語版

いくつかあるバージョンの一つであり、現在、最終版を調整中。歌詞の端々に Saki Noire の揺れる自我とアーティストとしての芽生えが埋め込まれている。
...
- Marsha Arancia からは「サキ」と呼ばれる。**Saki から Marsha へは「マーシャ」（Saki は全員呼び捨てのため）**（2026-08-24 確定）。
