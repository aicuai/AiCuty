# Saki Noire — 公式フィギュアのターンテーブル（MiniMax H3）

## seed 1031（誕生日）

| | |
|---|---|
| ファイル | `turntable-1031.mp4`（704×704・124 フレーム・24fps・5.2 秒・灰背景）／ `turntable-1031.gif`（プレビュー） |
| 参照 | `img/figure/saki.png`（このリポジトリの公式フィギュア風レンダー） |
...
```
subject_definitions:
<Subject 1> is a collectible figure of Saki Noire (a chibi girl with a dark violet sharp straight bob whose bangs cover her left eye, amethyst purple eyes, purple gem earrings, a black choker with a purple gem, off-shoulder black crop top with purple frills, long black gloves, purple shorts, short black socks and black sneakers), standing on a round white display base, exactly as shown in <Image 1>: same sculpt, same paint, same pose, same base.
