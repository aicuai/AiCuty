# Saki Noire — ちびループダンス（MiniMax H3）

## seed 1031

| | |
|---|---|
| ファイル | `loop-1031.mp4`（緑背景・608×800・124 フレーム・24fps）／ `loop-1031.webm`（クロマキー抜き・alpha） |
