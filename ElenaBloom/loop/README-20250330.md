...
| | |
|---|---|
| ファイル | `loop-20250330.mp4`（緑背景・608×800・124 フレーム・24fps）／ `loop-20250330.webm`（クロマキー抜き・alpha） |
...
| seed | 20250330 |
| 生成 | NVIDIA RTX 4000 Ada 20GB × 1、6 分、comfy-aicu Actions run 33718771419 |
| 検査 | 上余白 124px（全フレーム最小）／ 最初と最後のフレームの差 4.8（255 中） |
