...
- **担当名称の表記ゆれ**: ルール文書「調査・分析・倫理・法律担当」／リポジトリ README「調査・分析倫理担当」（法律が欠落）。本シートはルール文書を採用。
- **Seed の重複**: Mina と [Elena Bloom](../ElenaBloom/README.md) が同一 Seed（798458095628920）。原本 README 由来のため意図的か転記ミスか要確認。
