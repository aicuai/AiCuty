...
- Marsha Arancia からは「**ミナさん**」と呼ばれる（唯一の「さん」付け。ファクトチェックを頼む相手として少し畏れているため）。**Mina から Marsha へは「マーシャ」（Mina が「ちゃん」を付けるのはエレナのみのため）**（2026-08-24 確定）。
